...
// 1. Инициализация подсветки (белый цвет при старте)
...
// 3. Основная раскладка (строго 30 позиций на сторону для 5x6 матрицы)
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_charybdis_4x6(
        // Левая половина (24 основных + 5 больших + 1 заглушка KC_NO)
        ...
        // Правая половина (24 основных + 3 больших + 3 заглушки KC_NO)
...
// 4. Заглушки для VIA (чтобы не было ошибок при компиляции)
#ifdef VIA_ENABLE
